...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * The color purple.
     */
    public static final Color PURPLE = new Color(110, 36, 231);
    ...
    ***************************************************************************/
    ...
    /**
     * Draws a downward pointing triangle centered at (<em>x</em>, <em>y</em>) with length of <em>2 * halfLength</em> and height of <em>2 * halfHeight</em>.
     *
     ...
     */
    public static void downTriangle(double x, double y, double halfLength, double halfHeight) {
    ...
    /**
     * Draws a filled downward pointing triangle centered at (<em>x</em>, <em>y</em>) with length of <em>2 * halfLength</em> and height of <em>2 * halfHeight</em>.
     *
     * @param  x the <em>x</em>-coordinate of the center of the triangle
     * @param  y the <em>y</em>-coordinate of the center of the triangle
     * @param  halfLength one half the length of the triangle
     ...
     * @throws IllegalArgumentException if either {@code halfLength} or {@code halfHeight} is negative
     */
    public static void filledDownTriangle(double x, double y, double halfLength, double halfHeight) {
    	if (halfHeight <= 0 || halfLength <= 0) throw new IllegalArgumentException("half height or half length must be nonnegative");
